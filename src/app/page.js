...
export default function Home() {
  ...
  const filteredSensors = sensors.filter(sensor => {
    const matchLocation = selectedLocation ? sensor.description === selectedLocation : true;
    const matchSearch = searchTerm ? sensor.title.toLowerCase().includes(searchTerm.toLowerCase()) : true;
